"""
load_thermal_catalog(path::AbstractString,tm::Dict,sp::Dict,bdg::Dict)

Loads thermal equipment csv files from path directory and stores values
    in respective dictionary objects
...
function load_thermal_catalog(path::AbstractString,tm::Dict,sp::Dict,bdg::Dict)
