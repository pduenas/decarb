...
if __name__ == "__main__":
    ...
    for filepath in consumption_files:
        ...
        try:
            ...
            neep_df, peak_load_btu_hr = get_capacity_at_design_temp(neep_base, consumption_df, conditioned_area_sqft=building["conditioned_area_sqft"], verbose=False)
            ...
            if n_sufficient == 0:
                ...
                outdoor_temp_f = round(consumption_df.loc[peak_idx, "out.outdoor_air_drybulb_temp..c"] * 1.8 + 32, 1)
                zero_hp_match.append({
                    "bldg_id": building_id,
                    "peak_load_btu_hr": peak_load_btu_hr,
                    "outdoor_temp_f": round(outdoor_temp_f, 1),
                })
            else:
