...
PEAK_HOURS = {
    "elec_0_flat_results":   [],  # 6pm-10pm + 6am-10am
    "elec_100_flat_results": [],  # 6pm-10pm + 6am-10am
    "elec_0_tou_results":    [(18, 22), (6, 10)],  # 6pm-10pm + 6am-10am
    "elec_100_tou_results":    [(18, 22), (6, 10)],  # 6pm-10pm + 6am-10am
    # "elec_0_tou_v2_results":    [(18, 22), (5, 9)],  # 6pm-10pm + 5am-9am
    "elec_0_flat_cap_results":    [],  # 6pm-10pm + 5am-9am
    "elec_100_flat_cap_results":    [],  # 6pm-10pm + 5am-9am
}
...
def plot_comparison(all_results, baseline, output_dir):
    ...
    bars1 = ax.bar(x - width / 2, peak_vals,    width, label="Peak Electrical Demand (GWh)",     color="#e74c3c", edgecolor="white")
    bars2 = ax.bar(x + width / 2, offpeak_vals, width, label="Off-Peak Electrical Demand (GWh)", color="#4a90d9", edgecolor="white")
